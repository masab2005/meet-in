...
export default function ChatPage() {
...
) : (<div className="h-screen bg-[#f4efe1] flex flex-col max-w-md mx-auto relative">
  {/* Header */}
  <div className="bg-[#ffffff] p-4 flex items-center gap-3 sticky top-0 z-10 rounded-b-[2rem] shadow-[4px_4px_10px_rgba(0,0,0,0.1)]">
  ...
  {/* Input */}
  <div className="bg-[#fefffe] p-4 sticky bottom-0 rounded-t-[2rem] shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
    <form onSubmit={handleSendMessage} className="flex items-end gap-3">
      <textarea
        value={newMessage}
        onChange={(e) => setNewMessage(e.target.value)}
        placeholder="Type a message..."
        className="flex-1 px-4 py-3 rounded-[2rem] resize-none bg-[#f7f6f3] text-gray-800 border-none outline-none shadow-[inset_-4px_-4px_8px_rgba(255,255,255,0.6),inset_4px_4px_8px_rgba(0,0,0,0.05)] min-h-[48px] max-h-[120px]"
        rows={1}
        onKeyDown={(e) => {
